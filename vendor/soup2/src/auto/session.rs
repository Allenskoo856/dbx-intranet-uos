...
pub trait SessionExt: 'static {
    ...
    fn send_async<P: FnOnce(Result<gio::InputStream, glib::Error>) + 'static>(&self, msg: &impl IsA<Message>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P);
...
impl<O: IsA<Session>> SessionExt for O {
    ...
    fn send_async<P: FnOnce(Result<gio::InputStream, glib::Error>) + 'static>(&self, msg: &impl IsA<Message>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn send_async_trampoline<P: FnOnce(Result<gio::InputStream, glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
            let mut error = ptr::null_mut();
